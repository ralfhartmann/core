...
(
	...
	(
		...
		'keepRunonce' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['keepRunonce'],
			'inputType'               => 'checkbox',
			'eval'                    => array (
				'tl_class'              => 'w50'
			)
